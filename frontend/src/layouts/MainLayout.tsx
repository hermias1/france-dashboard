    ...
    <div className="flex min-h-screen bg-[var(--surface-primary)]">
      ...
      {!sidebarOpen && (
        <button
          ...
          className="lg:hidden fixed top-3 left-3 z-50 bg-[#0a0a1a]/90 backdrop-blur-sm text-white w-10 h-10 rounded-lg flex items-center justify-center shadow-lg"
          aria-label="Menu"
        >
          ☰
        </button>
      ...
      `}>
        <Sidebar onNavigate={handleNav} onClose={() => setSidebarOpen(false)} />
      </div>
