...
from app.routers import elections, energie, geo, question, delinquance, immobilier, accidents, fibre, loyers, brevet_router, territoire, sante, chomage, environnement, politique, mix_energie, insights
